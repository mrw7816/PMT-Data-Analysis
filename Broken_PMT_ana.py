...
pulseheight_C.SetDirectory(0)
pulsewidth_C.SetDirectory(0)
h2w_C.SetDirectory(0)
charge_height_C.SetDirectory(0)
charge_width_C.SetDirectory(0)
height_width_C.SetDirectory(0)
h2w_charge_C.SetDirectory(0)
inFile.Close()
...
charge_width_C.Write()
height_width_C.Write()
h2w_charge_C.Write()
outHistFile.Close()
